...
function GoogleIcon() {
  return (
    <svg className="w-[18px] h-[18px] sm:w-4 sm:h-4 flex-shrink-0" viewBox="0 0 24 24" fill="none">
...
function GitHubIcon() {
  return (
    <svg className="w-[18px] h-[18px] sm:w-4 sm:h-4 text-slate-200 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-12 xl:px-16 py-6 lg:py-6 h-full flex flex-col justify-between my-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1.25fr_0.75fr] xl:grid-cols-[1.3fr_0.7fr] gap-8 lg:gap-12 xl:gap-16 items-center w-full my-auto">
          ...
          <div className="flex flex-col justify-between w-full max-w-[820px] mx-auto lg:mx-0 space-y-4">
            ...
            {/* Main AI Neural Intelligence Pipeline Visualization (Desktop Only) */}
          ...
          <div className="w-full flex flex-col items-center justify-center my-auto">
            <div className="w-full max-w-[420px]">
              ...
              <div className="relative group bg-[#090f20]/90 backdrop-blur-2xl border border-white/[0.10] rounded-[24px] shadow-[0_0_50px_-10px_rgba(99,102,241,0.22)] p-7 sm:p-8 overflow-hidden">
                ...
                <div className="flex justify-center sm:justify-stretch gap-3">
                  <button
                    type="button"
                    onClick={handleGoogleLogin}
                    aria-label="Continue with Google"
                    className="w-[100px] sm:w-auto sm:flex-1 flex items-center justify-center gap-2 h-[44px] bg-[#070d1d]/80 border border-white/[0.08] rounded-xl text-[12.5px] font-semibold text-slate-200 hover:bg-white/[0.06] hover:border-white/[0.15] transition-all duration-200 active:scale-[0.99] cursor-pointer"
                  >
                    <GoogleIcon />
